...
This repository contains:
  ...
  - metadata extracted from WikiData:
      - WikiData IDS to Author Names mapping 
      - WikiData IDS to Occupation title mapping
      - Author ID to Occupation ID mapping
      - Automatically linked authors from LatinISE corpus 
